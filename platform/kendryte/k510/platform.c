...
static int kendryte_final_init(bool cold_boot)
{
	void *fdt;
...
static int kendryte_vendor_ext_provider(long extid, long funcid,
...
static int kendryte_domains_init(void)
{
...
const struct sbi_platform_operations platform_ops = {
	.final_init = kendryte_final_init,
	.domains_init = kendryte_domains_init,
	.console_init = fdt_serial_init,
	.irqchip_init = fdt_irqchip_init,
	.ipi_init     = fdt_ipi_init,
	.timer_init	   = fdt_timer_init,
	.vendor_ext_provider = kendryte_vendor_ext_provider
};
