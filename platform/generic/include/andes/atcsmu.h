...
#define SMU_RESET_VEC_8CORE_OFFSET 0x1a0
#define SMU_HARTn_RESET_VEC_LO(n)  \
	(SMU_RESET_VEC_LO_OFFSET + \
	 ((n) < 4 ? 0 : SMU_RESET_VEC_8CORE_OFFSET) + ((n)*0x4))
#define SMU_HARTn_RESET_VEC_HI(n)  \
	(SMU_RESET_VEC_HI_OFFSET + \
	 ((n) < 4 ? 0 : SMU_RESET_VEC_8CORE_OFFSET) + ((n)*0x4))
#define PCS_MAX_NR 8
